...
insert  into `usuarios`(`id_usuario`,`nombre_usuario`,`clave`,`habilitado`,`nombre`,`apellido`,`email`,`cambia_clave`,`id_persona`) values (1,'Vitty','3caracoles',1,'Vitty','Bugdahl','ebugdahl@gmail.com',0,NULL),(2,'Facu','gabibatistuta',0,'Facundo','Gardella','facugardella@hotmail.com',0,NULL),(4,'fer','onomatopeya',1,'Fernando','Duarte','fer@yahoo.com',0,NULL);
