...
insert  into `alumnos_inscripciones`(`id_inscripcion`,`id_alumno`,`id_curso`,`condicion`,`nota`) values (1,3,4,'inscripto',10);
...
CREATE TABLE `docentes_cursos` (
  ...
  CONSTRAINT `docentes_cursos_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id_curso`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

/*Data for the table `docentes_cursos` */

insert  into `docentes_cursos`(`id_dictado`,`id_curso`,`id_docente`,`cargo`) values (1,4,6,'titular'),(2,5,6,'titular');
...
insert  into `modulos`(`id_modulo`,`desc_modulo`,`ejecuta`) values (1,'alumnos_inscripciones','alumnos_inscripciones'),(2,'comisiones','comisiones'),(3,'cursos','cursos'),(4,'docentes_cursos','docentes_cursos'),(5,'especialidades','especialidades'),(6,'materias','materias'),(7,'modulos y modulo_usuarios','permisos'),(8,'personas','personas'),(9,'planes','planes'),(10,'usuarios','usuarios');
...
insert  into `modulos_usuarios`(`id_modulo_usuario`,`id_modulo`,`id_usuario`,`alta`,`baja`,`modificacion`,`consulta`) values (1,1,5,1,1,1,1),(2,2,5,1,1,1,1),(3,3,5,1,1,1,1),(4,4,5,1,1,1,1),(5,5,5,1,1,1,1),(6,6,5,1,1,1,1),(7,7,5,0,0,0,1),(8,8,5,1,1,1,1),(9,9,5,1,1,1,1),(10,10,5,1,1,1,1),(11,1,7,1,1,1,1),(12,2,7,1,1,1,1),(13,3,7,1,1,1,1),(14,4,7,1,1,1,1),(15,5,7,1,1,1,1),(16,6,7,1,1,1,1),(17,7,7,1,1,1,1),(18,8,7,1,1,1,1),(19,9,7,1,1,1,1),(20,10,7,1,1,1,1),(21,1,1,1,1,1,1),(22,2,1,1,1,1,1),(23,3,1,1,1,1,1),(24,4,1,1,1,1,1),(25,5,1,1,1,1,1),(26,6,1,1,1,1,1),(27,7,1,1,1,1,1),(28,8,1,1,1,1,1),(29,9,1,1,1,1,1),(30,10,1,1,1,1,1);
...
insert  into `usuarios`(`id_usuario`,`nombre_usuario`,`clave`,`habilitado`,`nombre`,`apellido`,`email`,`cambia_clave`,`id_persona`) values (1,'Vitty','3caracoles',1,'Vitty','Bugdahl','ebugdahl@gmail.com',0,3),(2,'Facu','gabibatistuta',0,'Facundo','Gardella','facugardella@hotmail.com',0,2),(5,'Admin','admin1234',1,'admin','admin','admin@utn.frro.com.ar',0,5),(6,'fernando','',1,'Fernando','Fernandez','fer@gmail.com',0,NULL),(7,'martin','dante',1,'Martin','Dante','martin@gmail.com',0,6);
